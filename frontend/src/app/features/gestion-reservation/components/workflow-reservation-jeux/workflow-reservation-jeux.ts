...
@Component({
  selector: 'app-workflow-reservation-jeux',
  standalone: true,
  imports: [CommonModule, MatButtonModule, MatFormFieldModule, MatSelectModule, MatIconModule],
  templateUrl: './workflow-reservation-jeux.html',
  styleUrl: './workflow-reservation-jeux.css'
})
export class WorkflowReservationJeux {
